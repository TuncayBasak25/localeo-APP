    ...
    <FullScreen>
      ...
      { /* Pseudo */ }
        ...
        <View style={[lay.row, lay.relW(100), lay.jc.between]}>
          ...
          <Image source={ (App.user.Avatar && !newAvatar) ? {uri: `data:images/jpeg;base64,${App.user.Avatar.data}`} : (newAvatar ? {uri: `data:images/jpeg;base64,${newAvatar}`} : require('../../../assets/avatar1.png')) }
